<!doctype html><html><head><meta charset="utf-8"><title>JC</title><meta name="viewport" content="width=device-width,initial-scale=1"><link href="/assets/favicon.ico" rel="icon" type="image/x-icon"> <?php
    ...
    ?> <script defer="defer" src="/index.bundle.js"></script></head><body><div id="root" style="min-height:200px;"></div><div id="portal"></div><div id="navbar-popper"></div></body></html>